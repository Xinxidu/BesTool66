...
#import "LocationMainViewController.h"
...
#define CELL_COUNT                      5
@interface LocationMainViewController ()<MAMapViewDelegate,MapPoiTableViewDelegate,AMapSearchDelegate,UISearchBarDelegate,SearchResultTableVCDelegate>

@end

@implementation LocationMainViewController
{
    MAMapView *_mapView;
    // 地图中心点的标记
